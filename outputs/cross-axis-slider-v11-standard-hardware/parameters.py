"""Named engineering parameters for the V11 printable mechanism.
...
BOM = {
    ...
    "compression_spring": {
        "quantity": 2,
        "spec": "custom SUS304-WPB: OD 14 x free 111 mm, wire 1.10 mm, about 32.8 active coils, rate 0.200 N/mm, solid length <=38 mm",
    },
    "spring_guide_rod": {
        "quantity": 2,
    ...
    "M4_shoulder_fastener_keyboard_guide": {
        "quantity": 4,
        "spec": "low-head precision shoulder screw: 4 mm shoulder x 20 mm, M3 x 4 mm thread, head 6 x 2 mm",
    },
    "M4_shoulder_fastener_trackpad_guide": {
        "quantity": 4,
        "spec": "low-head precision shoulder screw: 4 mm shoulder x 16 mm, M3 x 4 mm thread, head 6 x 2 mm",
    },
    "M4_shoulder_fastener_cross": {
        "quantity": 4,
        "spec": "low-head precision shoulder screw: 4 mm shoulder x 12 mm, M3 x 4 mm thread, head 6 x 2 mm",
    },
    "M3_retaining_nut": {
        "quantity": 12,
