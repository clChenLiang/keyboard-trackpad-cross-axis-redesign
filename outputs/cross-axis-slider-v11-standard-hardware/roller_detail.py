"""Selectable assembled/exploded details for the three V11 roller interfaces."""
...
def build_roller_detail(exploded: bool = True):
    ...
    return Compound(
        label="v11_roller_detail_exploded" if exploded else "v11_roller_detail_assembled",
        children=children,
    )
