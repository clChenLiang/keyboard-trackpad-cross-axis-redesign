...
def base_plate():
    return Compound(label="v11_base_plate", children=[
        _place("base", parts.make_open_base(), 0.0, 0.0),
    ])


def trays_plate():
    return Compound(label="v11_trays_plate", children=[
...
def frames_plate():
    return Compound(label="v11_frames_plate", children=[
...
def carriages_plate():
    return Compound(label="v11_carriages_plate", children=[
...
def petg_small_parts_plate():
    ...
    return Compound(label="v11_petg_small_parts_plate", children=children)
...
def tpu_parts_plate():
    ...
    return Compound(label="v11_tpu_parts_plate", children=children)


def small_parts_plate():
    """Legacy combined review plate; manufacturing uses two material plates."""
    return Compound(
        label="v11_small_parts_plate_review_only",
