"""Selectable assembled/exploded details for the three V10 roller interfaces."""
...
def build_roller_detail(exploded: bool = True):
    ...
    return Compound(
        label="v10_roller_detail_exploded" if exploded else "v10_roller_detail_assembled",
        children=children,
    )
