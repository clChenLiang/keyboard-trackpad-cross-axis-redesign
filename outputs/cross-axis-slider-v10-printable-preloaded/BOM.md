...
单位均为 mm。肩轴必须采用可配置 ISO 7379 或等效精密件；不要用全螺纹 M4 螺钉代替滚轮轴。
...
| ISO 7379 肩轴 | 4 | Ø4 光肩长 20.5；M3 螺纹端长 3.4 | 键盘导向 |
| ISO 7379 肩轴 | 4 | Ø4 光肩长 14.5；M3 螺纹端长 3.4 | 妙控板导向 |
| ISO 7379 肩轴 | 4 | Ø4 光肩长 10.5；M3 螺纹端长 3.4 | 交叉滚轮 |
...
| 零件 | 数量 | 精确规格 | 用途 |
|---|---:|---|---|
| 压缩弹簧 | 2 | OD 8，自由长 82，线径 0.55，约 11.5 有效圈，刚度约 0.19 N/mm，压并长不大于 8 | 双侧回位 |
| 不锈钢精密杆 | 2 | Ø3.0 × 91.0，端面倒钝 | 弹簧防屈曲导杆兼端位环载体 |
...
- 三种肩长由装配基准直接推导，左右误差为 0；替换长度会改变轴向夹紧或留下间隙。
- 弹簧不是仅按外形选取。若刚度或自由长变化，必须重新运行 `validation.py` 的回位力与压并检查。
